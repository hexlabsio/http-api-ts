...
export function allFilters<Req extends Request, Res extends { headers?: any, statusCode: any, body: any}>(version: string, corsConfig: CorsConfig, logErrors = true): Filter<Req, Res> {
